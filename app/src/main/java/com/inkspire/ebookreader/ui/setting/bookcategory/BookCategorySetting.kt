...
fun BookCategorySetting() {
    ...
    Column(
        ...
        Row(
                    ...
                    IconButton(
                        onClick = {
                            if (categoryName.isNotBlank()) {
                                viewModel.onAction(
                                    BookCategorySettingAction.AddCategory(
                                        Category(
            ...
            IconButton(
                onClick = {
                    viewModel.onAction(BookCategorySettingAction.DeleteCategory)
                }
            ) {
                Icon(
        ...
        FlowRow(
            ...
            state.bookCategories.forEach { categoryChip ->
                MyBookChip(
                    selected = categoryChip.isSelected,
                    color = Color(categoryChip.color),
                    onClick = {
                        viewModel.onAction(BookCategorySettingAction.ChangeChipState(categoryChip))
                    }
                ) {
